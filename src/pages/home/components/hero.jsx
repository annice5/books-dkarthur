...
const Hero = () => {
  return (
    <section className="grid min-h-screen grid-cols-1 md:grid-cols-2">
      <div className="order-2 flex flex-col justify-center bg-[#e7e7e4] px-6 py-16 pt-20 sm:px-8 md:order-1 md:justify-start md:px-16 md:pt-32">
      ...
      <div className="order-1 relative flex items-start justify-center bg-white px-6 pt-20 sm:px-8 md:order-2 md:justify-end md:px-12 md:pt-32 md:pr-32">
